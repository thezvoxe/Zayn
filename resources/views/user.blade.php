                                ...
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            <h6 class="mb-0 text-gray-600">Setyo / Zayn Voxe</h6>
                                            <p class="mb-0 text-sm text-gray-600">Pembantai Forex</p>
                                        </div>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tampilan User</h3>
                <p class="text-subtitle text-muted">Pages untuk menampilkan, menambah, menghapus, dan mengedit data user.</p>  
            </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h4 class="card-title">Table Users Data</h4 >
                    <a href="" class="btn btn-secondary"><i class="bi bi-plus-circle"></i></a>
            </div>
        </div>
        <table class="table">
            <thead>
